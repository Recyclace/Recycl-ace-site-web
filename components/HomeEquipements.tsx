        ...
        <div>
          ...
          <p className="mt-5 max-w-md text-lg text-encre/70">
            {en
              ...
              : "Nous cherchons à instaurer une circularité dans le sport en recyclant les balles en nouveaux équipements sportifs durables et performants."}
          </p>
          ...
          <Link href="/nos-equipements" className="btn-primary mt-8 inline-flex">{en ? "Explore the Ace range" : "Découvrir la gamme Ace"}</Link>
        </div>
      </div>
    </section>
  );
