...
export default function ProductDetail({ product }: { product: Product }) {
  ...
  const [colorIdx2, setColorIdx2] = useState(1);
  ...
  const handleAdd = () => {
    ...
    add({ productId: product.id, slug: product.slug, name: tField(product.name, lang), price: product.price, color: colorLabel, colorHex: color.hex, image: color.images[0] }, qty);
    setJustAdded(true);
    ...
    <div className="container-x py-10 md:py-16">
      ...
      <div className="grid gap-10 lg:grid-cols-2">
        ...
        <div className="lg:pt-4">
          ...
          <p className="mt-6 text-encre/70">{tField(product.description, lang)}</p>
